...
public class wavClass {
    ...
    public wavClass(String path, String fileraw,String filewave){
        try{
            filePath = path;
            tempRawFile = fileraw;
            tempWavFile = filewave;
    ...
    private void wavHeader(FileOutputStream fileOutputStream,long totalAudioLen,long totalDataLen,int channels,long byteRate){
        try {
            ...
            header[2] = 'F';
            header[3] = 'F';
            header[4] = (byte) (32036 & 0xff);
            header[5] = (byte) ((32036 >> 8) & 0xff);
            ...
            header[38] = 't';
            header[39] = 'a';
            header[40] = (byte) (32000 & 0xff);
            header[41] = (byte) ((32000 >> 8) & 0xff);
